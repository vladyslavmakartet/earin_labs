...
def main() -> None:
    ...
    print('============================================================')
    print(GradientDescent.calculate_minimum(example_g, numpy.matrix([[1], [2]]), BREAK_ITERATIONS, 200))
    print(NewtonMethod.calculate_minimum(example_g, numpy.matrix([[1], [2]]), BREAK_ITERATIONS, 200))
    print('============================================================')
