...
def main() -> None:
    ...
    a = numpy.matrix([[9, 1, 3], [1, 5, 4], [5, 8, 9]])
    b = numpy.matrix([[1], [2], [4]])
    c = 1
    ...
    print('============================================================')
    print(GradientDescent.calculate_minimum(example_g, numpy.matrix([[2], [2], [3]]), BREAK_ITERATIONS, 200))
    print(NewtonMethod.calculate_minimum(example_g, numpy.matrix([[2], [2], [3]]), BREAK_ITERATIONS, 200))
    print('============================================================')
